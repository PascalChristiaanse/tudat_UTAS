function(TUDAT_ADD_EXECUTABLE arg1 arg2)
    ...
    # Use modern CMake imported targets instead of ${Boost_LIBRARIES} to avoid 
    # optimized/debug generator expression issues
    target_link_libraries("${target_name}"
            PUBLIC    ${ARGN}
            PRIVATE   Boost::filesystem Boost::system Boost::regex Boost::date_time 
                      Boost::thread Boost::chrono Boost::atomic Boost::unit_test_framework
            )
